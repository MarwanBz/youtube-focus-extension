...
| T002 | Todo | P0 | Configure manifest for YouTube content script | T001 | Content script runs on `https://www.youtube.com/*`; minimal permissions are declared. |
| T003 | Todo | P0 | Add settings schema and storage wrapper | T001 | Defaults exist; settings can be read and written from popup/options/content code. |
| T004 | Todo | P0 | Detect YouTube home route in content script | T002 | Content script can distinguish home page from watch, shorts, search, and playlist pages. |
