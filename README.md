...
Current stage: preparing a non-AI release. Focus Mode, Watch Later, playlist/channel shelves, temporary pause, OAuth import, and watch-page soft focus remain active; AI UI and runtime paths are preserved in code but disabled.
